...
const mockAd: Ad = {
  ...
  seller: { id: 1, name: 'Test Seller', rating: '4.8', totalAds: 5, registeredAt: '' },
  characteristics: { 'Состояние': 'Б/у', 'Гарантия': 'Нет', 'Производитель': 'TestBrand', 'Модель': 'TestModel', 'Цвет': 'Черный' },
  moderationHistory: [],
};
...
describe('AdCard component', () => {
    it('renders ad details correctly', () => {
        ...
        expect(screen.getByText(`Транспорт • ${new Date(new Date().toISOString()).toLocaleDateString()}`)).toBeInTheDocument();
